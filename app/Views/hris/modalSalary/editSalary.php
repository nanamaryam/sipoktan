...
<section class="section">
    ...
    <?php endif; ?>
    <?php foreach ($dataSalary as $value) : ?>
        <form action="<?= base_url('salary/update/' . $value['id']); ?>" method="POST" enctype="multipart/form-data">
            <?= csrf_field() ?>
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="<?= base_url('salary/editsalary/' . $value['id']); ?>" type="button" class="btn btn-primary rounded-pill ml-2" data-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Reset"><i class="bi bi-arrow-clockwise"></i></a>
                </div>
                                ...
                                <div class="row m-lg-5">
                                    ...
                                    <div class="col-md-8 form-group ">
                                        <div class="input-group">
                                            <input type="hidden" name="id_karyawan" id="idKaryawan" value="<?= $value['id']; ?>">
                                            <input type="text" class="form-control" name="" id="dataKaryawan" value="<?= $value['nama_karyawan']; ?>" readonly>
