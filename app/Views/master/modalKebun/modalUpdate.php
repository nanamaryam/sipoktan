...
<div class="modal fade text-left" id="updateKebun<?= $value['id']; ?>" tabindex="-1" role="dialog"
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_comodity" id="" class="form-control">
                            ...
                            <?php
                                    $id_comodity = $value['id_comodity'];
                                    foreach ($dataComodity as $a) :
                                        $ss = '';
                                        if ($a['id'] == $id_comodity) {
                                            $ss = 'selected';
                                        }
                                    ?>
                            <option value="<?= $a['id']; ?>" <?= $ss ?>><?= $a['comodity']; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="form-group">
