    ...
    <form action="<?= base_url('karyawan/edit/' . $value['id']); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="<?= base_url('karyawan/editkaryawan/' . $value['id']); ?>" type="button"
                    ...
                    <div class="col-lg-6" id="">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" name="" id="dataKebun"
                                    value="<?= $value['lokasi']; ?>  " readonly>
