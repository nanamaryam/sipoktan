    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h5 class="modal-title white" id="myModalLabel160">Export Excel Pengeluaran</h5>
            ...
            <div class="modal-body">
                <center>
                    <form action="<?= base_url('cost/exportexcel') ?>" method="post" target="_blank" enctype="multipart/form-data">
                        <?= csrf_field() ?>
                        <button type="submit" class="btn btn-success rounded-pill mb-4">Export Excel All</button>
                    </form>
                    <br>
                    <form action="<?= base_url('cost/excelfilter') ?>" method="post" target="_blank" enctype="multipart/form-data">
                        <?= csrf_field() ?>
