...
<div class="modal fade text-left" id="updatePanen<?= $value['id']; ?>" tabindex="-1" role="dialog"
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" value="<?= $value['harga_perkilo']; ?>"
                                name="harga_perkilo" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="">Berat</label>
                        <div class="input-group">
                            <input type="number" class="form-control" name="berat" value="<?= $value['berat']; ?>"
                                required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" name="pendapatan"
                                value="<?= $value['pendapatan']; ?>" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="">Keterangan</label>
                        <textarea name="ket_panen" class="form-control" id="exampleFormControlTextarea1" rows="3"
                            required><?= $value['ket_panen']; ?></textarea>
                    </div>
                </div>
