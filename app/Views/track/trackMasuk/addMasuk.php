    ...
    <form action="<?= base_url('masuk/simpan'); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="<?= base_url('masuk/addmasuk'); ?>" style="margin-right: 5px;" type="button" class="btn btn-primary rounded-pill mr-2 float-end" data-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Reset"><i class="bi bi-arrow-clockwise"></i></a>
            </div>
            <div class="card-body">
...
<?= $this->include('track/trackMasuk/modalView'); ?>
            ...
            <tr>
                ...
                <td>
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control" name="harga_masuk[]" value="` + $(d).data('hargasatuan') + `" readonly>
                    </div>
                </td>
